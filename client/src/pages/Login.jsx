                ...
                <form className='grid gap-4 py-4' onSubmit={handleSubmit}>
                    <div className='grid gap-1'>
                        ...
                        <input
                            type='email'
                            id='email'
                            className='bg-red-50 p-2 border rounded outline-none focus:border-red-400'
                            name='email'
                            value={data.email}
                    ...
                    <div className='grid gap-1'>
                        ...
                        <div className='bg-red-50 p-2 border rounded flex items-center focus-within:border-red-400'>
                            <input
                        ...
                        <Link to={"/forgot-password"} className='block ml-auto hover:text-red-700'>Forgot password ?</Link>
                    </div>
