...
const UploadProduct = () => {
  ...
  const handleUploadImage = async(e)=>{
    ...
    try {
      ...
      const imageUrl = ImageResponse?.data?.url || ImageResponse?.secure_url || ImageResponse?.url
  ...
  const handleSubmit = async(e)=>{
    ...
    const payload = {
      ...
      category: Array.isArray(data.category)
        ? data.category.map((item) => (typeof item === 'string' ? item : item?._id)).filter(Boolean)
        : [],
      subCategory: Array.isArray(data.subCategory)
        ? data.subCategory.map((item) => (typeof item === 'string' ? item : item?._id)).filter(Boolean)
        : [],
    }
