  ...
  return (
    <div>
        ...
        <div className='text-sm grid gap-1'>
            ...
            {
              isAdmin(user.role) && (
                <Link onClick={handleClose} to={"/dashboard/payment-qr"} className='px-2 hover:bg-orange-200 py-1'>Payment QR</Link>
              )
            }
            {
              isAdmin(user.role) && (
            ...
            {
              isAdmin(user.role) && (
                <Link onClick={handleClose} to={"/dashboard/admin-users"} className='px-2 hover:bg-orange-200 py-1'>Admin Users</Link>
              )
            }
            {
              isAdmin(user.role) && (
                <Link onClick={handleClose} to={"/dashboard/sales-report"} className='px-2 hover:bg-orange-200 py-1'>Sales Reports</Link>
              )
            }
